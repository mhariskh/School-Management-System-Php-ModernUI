...
<form method = "post" action = "code.php">
  ...
  <input class="form-check-input big-checkbox" type="checkbox" name ="paymentid[]" value="<?php  echo $row ['s_rollno'];?>" id="flexCheckDefault">
...
<!-- <td><div id="paymentReason" >
    ...
    ?>
                ...
                <div>  <a href="finance.php" class="btn btn-primary  float-left ">Goback</a></div>   
